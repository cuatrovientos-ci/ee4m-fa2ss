...
**DESCRIPCIÓN**: El módulo está diseñado para optimizar las operaciones de almacén mediante una serie de cursos específicos. Abarca la implantación de un programa de 5S para mantener un entorno organizado y eficiente, e integra los principios de Lean Six Sigma para mejorar los procesos logísticos. Además, el módulo incluye formación sobre la realización de evaluaciones de riesgos en el almacén, la definición y utilización de indicadores clave de rendimiento (KPI) para la mejora continua y la selección de sistemas informáticos adecuados, como los sistemas de gestión de almacenes (SGA), para racionalizar las operaciones.

**COMPETENCIAS**
- Habilidades de gestión de riesgos: Esencial para llevar a cabo evaluaciones de riesgos en el almacén y garantizar la seguridad y el cumplimiento dentro del entorno del almacén.		
- Capacidad de pensamiento analítico: Importante para definir e implementar indicadores clave de rendimiento (KPI) para supervisar y mejorar las operaciones del almacén.		
- Capacidades tecnológicas: Fundamentales para seleccionar e implantar sistemas informáticos adecuados, como los sistemas de gestión de almacenes (SGA), para optimizar los procesos de almacén.		
